...
<ul id="main-nav" class="advanced-tutor">
    ...
    <li id="secondtab" <c:if test="${requestScope['javax.servlet.forward.request_uri'].contains('/alltests')}">
        class="active"</c:if>>
        <a href="${context }/advanced-tutor/alltests/page/1">All tests</a>
    <li id="thirdtab" <c:if test="${requestScope['javax.servlet.forward.request_uri'].contains('/create-test')}">
        class="active"</c:if>>
        <a href="${context }/advanced-tutor/new-test">New test</a>
</ul>
